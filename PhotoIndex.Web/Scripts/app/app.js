...
app.config(['$routeProvider', '$locationProvider', '$httpProvider', '$provide', function ($routeProvider, $locationProvider, $httpProvider, $provide) {
    ...
    $routeProvider
        ...
        .when('/Photos', { templateUrl: '/Scripts/app/views/photos/Photos-ng-table.html', controller: 'PhotosCtrl' })
        .when('/Photos/:photoId', { templateUrl: '/Scripts/app/views/photos/Details.html', controller: 'PhotosCtrl' })
