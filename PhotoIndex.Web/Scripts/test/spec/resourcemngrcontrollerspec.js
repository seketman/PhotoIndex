describe("Resource Manager Controller", function () {
    ...
    var userData = { Email: "test@g.com", Password: "PhotoIndex" };
    var invalidUserRegistrationData = { email: "test@g.com", password: "PhotoIndex", confirmPassword: 'PhotoIndex1', firstName: 'first', lastName: 'last' };
    var validUserRegistrationData = { email: "test@g.com", password: "PhotoIndex", confirmPassword: 'PhotoIndex', firstName: 'first', lastName: 'last' };
